...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
							...
							<c:if test="${totalCntDailyOrder > 0 }">
								...
								<c:forEach items="${listDailyOrder}" var="list">
									<tr>
										...
										<td><a class="btnType3 color1" href="javascript:fPopModalComnGrpCod('${list.order_no}');"><span>배송</span></a></td>
							...
							<input type="hidden" id="totalCntDailyOrder" name="totalCntDailyOrder" values="${totalCntDailyOrder}"/>